...
world_elevation <- read_stars (here::here("week 1", "data", "worldelevation.tif"))

# country boundaries
world_vector <- read_sf(here::here("week 1", "data", "worldvector.gpkg"))

# major cities
world_cities <- read_sf (here::here("week 1", "data", "worlcities.gpkg"))
